...
nlp = spacy.load("/home/wxy/下载/en_core_sci_scibert-0.5.0/en_core_sci_scibert/en_core_sci_scibert-0.5.0")
...
def main_roco(cache_path="data/pretrain_data/cache_data.pkl"):
    # if not os.path.exists(cache_path):
    #     roco_data = prepro_roco()
    #     fout = open(cache_path, "wb")
    ...
    #         os.path.exists("data/knowledge/entity2id.txt") and
    #         os.path.exists("data/knowledge/relation2id.txt")):
    #     entity2id, relation2id = create_entity_vocab([roco_data])
    # else:
    #     entity2id, relation2id = {}, {}
    #     for line_idx, line in enumerate(open("data/knowledge/entity2id.txt")):
    #         if line_idx == 0:
    ...
    # datas = filter_datas([roco_data], entity2id)
    # roco_data = datas[0]
    # make_arrow(roco_data, "roco", "data/pretrain_arrows_umls/")
    print('123')
